...
class UrlGetter:
    ...
    def get_afp_url(self, category, page):
        return "http://www.afpbb.com/category/{}?page={}".format(category, page)
...
def run():
    ...
    for i in tqdm(range(3500)):
        base_url = urlgetter.get_url(site_type, category, i+1)
...
if __name__ == "__main__":
    ...
    run().to_csv("afp_sports.csv", index=False)
